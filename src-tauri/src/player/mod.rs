...
impl PlayerHandle {
    ...
    pub fn dolby_capabilities(&self) -> serde_json::Value {
        ...
        serde_json::json!({
            ...
            "ffmpegVersion": property("ffmpeg-version"),
            "libplaceboVersion": property("libplacebo-version"),
            ...
            "current": {
                ...
                "audioFormat": property("audio-out-params/format"),
                ...
                "videoTargetPrimaries": property("video-target-params/primaries"),
                "videoTargetTransfer": property("video-target-params/gamma"),
                "dolbyVisionProfile": property("current-tracks/video/dolby-vision-profile"),
                "dolbyVisionLevel": property("current-tracks/video/dolby-vision-level"),
            },

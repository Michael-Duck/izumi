...
<nav aria-label="Library sections" class="flex flex-wrap items-center gap-x-6 gap-y-2 border-b border-border px-4 pt-4 sm:px-8">
  ...
  {/each}
  <a href="/app/settings/accounts?section=libraries" data-focusable class="ml-auto inline-flex min-h-12 items-center text-sm text-muted-foreground hover:text-foreground">Manage services</a>
</nav>

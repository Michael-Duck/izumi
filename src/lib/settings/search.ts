...
export const SETTINGS_SEARCH_INDEX: SettingSearchItem[] = [
  ...
  { title: 'Auto-skip openings & endings', category: 'Player', href: '/app/settings/player', keywords: 'op ed intro outro recap chapters skip times', anchored: true, desktopOnly: true },
  { title: 'Auto-skip next-episode previews', category: 'Player', href: '/app/settings/player', keywords: 'preview next episode trailer chapters', anchored: true, desktopOnly: true },

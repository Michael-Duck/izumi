...
export const anilistUserName = profiledPersisted('anilist-viewer-name', '')
export const anilistUserAvatar = profiledPersisted('anilist-viewer-avatar', '')
export const malToken = profiledPersisted<string | null>('mal-token', null)
export const malRefresh = profiledPersisted<string | null>('mal-refresh', null)
...
export const malTokenExpiry = profiledPersisted<number>('mal-token-expiry', 0)
export const malUserName = profiledPersisted('mal-viewer-name', '')
export const malUserAvatar = profiledPersisted('mal-viewer-avatar', '')
export const kitsuToken = profiledPersisted<string | null>('kitsu-token', null)
export const kitsuRefresh = profiledPersisted<string | null>('kitsu-refresh', null)
export const kitsuTokenExpiry = profiledPersisted<number>('kitsu-token-expiry', 0)
export const kitsuUserId = profiledPersisted<string>('kitsu-viewer-id', '')
export const kitsuUserName = profiledPersisted('kitsu-viewer-name', '')
export const kitsuUserAvatar = profiledPersisted('kitsu-viewer-avatar', '')
export const simklToken = profiledPersisted<string | null>('simkl-token', null)
export const simklUserName = profiledPersisted('simkl-viewer-name', '')
export const simklUserAvatar = profiledPersisted('simkl-viewer-avatar', '')
export const trackerConnectionOrder = profiledPersisted<TrackerRatingProvider[]>('tracker-connection-order', [])
...
export const malUser = profiledPersisted<string>('mal-username', '')

...
export const TMDB_HOME_ROWS: CatalogHomeRowOption[] = [
  ...
  { id: 'critics-pick', title: 'Critics’ Pick', description: 'A daily pick from widely rated, acclaimed films.', group: 'Editorial', defaultEnabled: true },
  { id: 'mood-now', title: 'Mood of the Moment', description: 'A time-aware film mood that rotates without reshuffling mid-session.', group: 'Editorial', defaultEnabled: true },
  { id: 'world-cinema', title: 'World Cinema Spotlight', description: 'A rotating selection of acclaimed films beyond English-language cinema.', group: 'Editorial', defaultEnabled: true },
  { id: 'network-spotlight', title: 'Network Spotlight', description: 'A rotating shelf from leading television networks.', group: 'Editorial', defaultEnabled: true },
  ...
  { id: 'mood-comfort', title: 'Comfort Watch', description: 'Warm comedy, family and animation favourites.', group: 'Mood', defaultEnabled: false },
  { id: 'mood-mind-benders', title: 'Mind Benders', description: 'Acclaimed science-fiction mysteries and thrillers.', group: 'Mood', defaultEnabled: false },
  { id: 'mood-after-dark', title: 'After Dark', description: 'Popular horror and thriller films for late nights.', group: 'Mood', defaultEnabled: false },
  { id: 'world-korean', title: 'Korean Cinema', description: 'Highly rated Korean-language films.', group: 'World cinema', defaultEnabled: false },
  { id: 'world-japanese', title: 'Japanese Cinema', description: 'Highly rated Japanese-language films.', group: 'World cinema', defaultEnabled: false },
  { id: 'world-french', title: 'French Cinema', description: 'Highly rated French-language films.', group: 'World cinema', defaultEnabled: false },
  { id: 'network-hbo', title: 'HBO', description: 'Popular and acclaimed HBO series.', group: 'Networks', defaultEnabled: false },
  { id: 'network-apple', title: 'Apple TV+', description: 'Popular Apple TV+ series.', group: 'Networks', defaultEnabled: false },
  { id: 'network-fx', title: 'FX', description: 'Popular and acclaimed FX series.', group: 'Networks', defaultEnabled: false },
]

...
<div class="p-4 sm:p-8">
  ...
  <div class="max-w-2xl space-y-3">
    ...
    <Toggle label="Auto-skip openings & endings" desc="Skip intro, recap, and outro segments automatically (AniSkip, IntroDB, and file chapters). Off shows a manual Skip button." value={$autoSkip} onToggle={() => ($autoSkip = !$autoSkip)} />
